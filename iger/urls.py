...
urlpatterns = [
    ...
    path('carnet', views.carnet2, name='carnet2'),
    ...
    path('student', views.detail2, name='detail2'),
	...
	path('students/31082019/libro_FisicaHTML', views.libro_FisicaHTML, name='libro_FisicaHTML')
    ]
